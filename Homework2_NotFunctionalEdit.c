...
int main (void)
{
	...
	/*
		Per the comment left on the submission,
		when variables "area" and "circ" are delcared up here
		they aren't properly updated, and the final printout
		statement returns a 0.00 for both "area" and "circ". Why?
	*/
